...
void Image::Store(std::string_view path, const float* RGBA_float_data, uint32_t width, uint32_t height) {
	stbi_flip_vertically_on_write(true);
	stbi_write_hdr(path.data(), width, height, 4, RGBA_float_data);
}
